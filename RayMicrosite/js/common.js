...
$(document).ready(function(){
    $(document).mousemove(function(event){
		...
		$('.page01 .obj01').stop().animate({'margin-left':(event.pageX-10)*0.017}, 400);
		$('.page01 .obj02').stop().animate({'margin-left':(-(event.pageX-10)*0.02)}, 500);
/*--
...
$(function(){	
	...
	$(window).scroll(function(){
		var scrollTop = $(document).scrollTop();
			...
			if(scrollTop > 600 && scene02Num==1){
				scene02Ani();
			}

			if(scrollTop > 1600 && scene03Num==1){
				scene03Ani();
			}

			if(scrollTop > 2900 && scene05Num==1){
				scene05Ani();
			}
